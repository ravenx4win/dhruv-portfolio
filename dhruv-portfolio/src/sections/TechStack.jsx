...
import { FaPython, FaGithub, FaCloud, FaBrain } from 'react-icons/fa'
import { SiFastapi, SiPlaywright, SiFlask, SiScikitlearn, SiDjango } from 'react-icons/si'
...
const TechStack = () => {
  const technologies = [
    ...
    { name: "LangChain", icon: FaBrain, color: "text-purple-600" },
    { name: "RAG (Retrieval-Augmented Generation)", icon: FaBrain, color: "text-indigo-500" },
